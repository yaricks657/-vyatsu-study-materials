...
PROCEDURE DrawLine(x1, color1, x2, color2, y : Integer);
VAR
    x : Integer;
BEGIN
if x1 = x2 then begin
...
PROCEDURE DrawTriangle(x1, y1, color1,  x2, y2, color2,  x3, y3, color3 : Integer);
VAR
    y: Integer;
...
if y1 = y3 then begin
    DrawLine(x1, color1, x3, color3, y1);
    exit;
    end;
if y1 <> y2 then
    for y := y1 to y2 do begin
        ...
        DrawLine(x_line_A, color_line_A, x_line_B, color_line_B, y);
        sleep(10);
        end;
if y2 <> y3 then
...
DrawTriangle(x1, y1, color1,  x2, y2, color2,  x3, y3, color3);
end;
