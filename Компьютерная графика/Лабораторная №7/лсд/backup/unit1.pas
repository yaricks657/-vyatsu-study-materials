...
begin
    xx:=220;
     xy:=210;
     Canvas.Line(round(vvv[1].x+xx), round(vvv[1].y+xy), round(vvv[2].x+xx), round(vvv[2].y+xy));
 Canvas.Line(round(vvv[2].x+xx), round(vvv[2].y+xy), round(vvv[3].x+xx), round(vvv[3].y+xy));
 Canvas.Line(round(vvv[3].x+xx), round(vvv[3].y+xy), round(vvv[4].x+xx), round(vvv[4].y+xy));
 Canvas.Line(round(vvv[4].x+xx), round(vvv[4].y+xy), round(vvv[5].x+xx), round(vvv[5].y+xy));
 Canvas.Line(round(vvv[5].x+xx), round(vvv[5].y+xy), round(vvv[6].x+xx), round(vvv[6].y+xy));
 Canvas.Line(round(vvv[6].x+xx), round(vvv[6].y+xy), round(vvv[7].x+xx), round(vvv[7].y+xy));
 Canvas.Line(round(vvv[7].x+xx), round(vvv[7].y+xy), round(vvv[8].x+xx), round(vvv[8].y+xy));
 Canvas.Line(round(vvv[8].x+xx), round(vvv[8].y+xy), round(vvv[1].x+xx), round(vvv[1].y+xy));
 Canvas.Line(round(vvv[1].x+xx), round(vvv[1].y+xy), round(vvv[4].x+xx), round(vvv[4].y+xy));
 Canvas.Line(round(vvv[3].x+xx), round(vvv[3].y+xy), round(vvv[6].x+xx), round(vvv[6].y+xy));
 Canvas.Line(round(vvv[2].x+xx), round(vvv[2].y+xy), round(vvv[7].x+xx), round(vvv[7].y+xy));
 Canvas.Line(round(vvv[5].x+xx), round(vvv[5].y+xy), round(vvv[8].x+xx), round(vvv[8].y+xy));
  Canvas.Line(round(vvv[5].x+xx), round(vvv[5].y+xy), round(vvv[8].x+xx), round(vvv[8].y+xy));
 {Form1.Canvas.Pen.Color:=clWhite;
 for i:=0 to 750 do
    Form1.Canvas.Line(0,i,1000,i);
