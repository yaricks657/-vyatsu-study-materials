...
begin
 ...
 Form1.Canvas.FillRect(Form1.Canvas.ClipRect);
       v[1].x:=-200; v[1].y:=-160; v[1].z:= 0;
       v[2].x:=-200; v[2].y:=  0; v[2].z:= 0;
       v[3].x:=  0; v[3].y:=  0; v[3].z:= 0;
       v[4].x:=  0; v[4].y:=-160; v[4].z:=0;
       v[5].x:=  0; v[5].y:=-160; v[5].z:=180;
       v[6].x:=  0; v[6].y:=  0; v[6].z:=180;
       v[7].x:=-200; v[7].y:=  0; v[7].z:=180;
       v[8].x:=-200; v[8].y:=-160; v[8].z:=180;
