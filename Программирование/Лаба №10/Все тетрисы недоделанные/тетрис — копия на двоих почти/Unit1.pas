...
function ggprav():boolean;
begin
if (fig='4')
and (a[q[1,8],q[2,8]+1]<>2)
and (a[q[1,8],q[2,8]+2]<>2)
and (a[q[1,7],q[2,7]+1]<>2)
and (a[q[1,6],q[2,6]-1]<>2)
and (a[q[1,5],q[2,5]-1]<>2)
then ggprav:=true else ggprav:=false;
end;

function gglev():boolean;
begin
if (fig='3')
and (a[q[1,5],q[2,5]+1]<>2)
and (a[q[1,5],q[2,5]+2]<>2)
and (a[q[1,7],q[2,7]+1]<>2)
and (a[q[1,8],q[2,8]-1]<>2)
and (a[q[1,5],q[2,5]-1]<>2)
then gglev:=true else gglev:=false;
end;

function kkrest():boolean;
begin
if (fig='2')
and (a[q[1,5],q[2,5]+2]<>2)
and (a[q[1,5],q[2,5]+1]<>2)
and (a[q[1,7],q[2,7]+2]<>2)
and (a[q[1,7],q[2,7]+1]<>2)
and (a[q[1,8],q[2,8]+1]<>2)
and (a[q[1,7],q[2,7]-1]<>2)
then kkrest:=true else kkrest:=false;
end;

function ppalka():boolean;
begin
if (fig='1')
and (a[q[1,5]+1,q[2,5]]<>2)
and (a[q[1,5]+2,q[2,5]]<>2)
and (a[q[1,5]+3,q[2,5]]<>2)
and (a[q[1,5]+4,q[2,5]]<>2)

and (a[q[1,6]+1,q[2,6]]<>2)
and (a[q[1,6]+2,q[2,6]]<>2)
and (a[q[1,6]+3,q[2,6]]<>2)
and (a[q[1,6]+4,q[2,6]]<>2)

and (a[q[1,7]+1,q[2,7]]<>2)
and (a[q[1,7]+2,q[2,7]]<>2)
and (a[q[1,7]+3,q[2,7]]<>2)
and (a[q[1,7]+4,q[2,7]]<>2)

and (a[q[1,8]+1,q[2,8]]<>2)
and (a[q[1,8]+2,q[2,8]]<>2)
and (a[q[1,8]+3,q[2,8]]<>2)
and (a[q[1,8]+4,q[2,8]]<>2)
then ppalka:= true else ppalka:=false;
end;
...
begin
  if kkek=0 then  Form1.Timer1.Enabled := false;
 /////////////////////////////////////////////

if (q[2,8]>27) or (q[2,5]>27) or (q[2,6]>27)
or (q[2,7]>27)
or (a[q[1,8],q[2,8]+1]=2)
or (a[q[1,7],q[2,7]+1]=2)
or (a[q[1,6],q[2,6]+1]=2)
or (a[q[1,5],q[2,5]+1]=2) then
begin
for i:= 5 to 8 do
a[q[1,i],q[2,i]]:=2;
SecondF;
...
if (key = vk_left) and (q[1,5]>1)
and (q[1,6]>1) and (q[1,7]>1)
and (q[1,8]>1)
and (2<>a[q[1,5]-1,q[2,5]])
and (2<>a[q[1,6]-1,q[2,6]])
and (2<>a[q[1,7]-1,q[2,7]])
and (2<>a[q[1,8]-1,q[2,8]])
then
for i:= 5 to 8 do
q[1,i]:=q[1,i]-1;


if (key = vk_right) and (q[1,8]<23)
and (q[1,6]<23) and (q[1,7]<23)
and (q[1,5]<23)
and (2<>a[q[1,5]+1,q[2,5]])
and (2<>a[q[1,6]+1,q[2,6]])
and (2<>a[q[1,7]+1,q[2,7]])
