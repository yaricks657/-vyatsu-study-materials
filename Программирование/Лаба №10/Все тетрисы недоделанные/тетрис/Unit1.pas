...
begin
for j:=1 to 28 do
if (a[1,j]=0) and (a[2,j]=0) and
(a[3,j]=0) and (a[4,j]=0) and
(a[5,j]=0) and (a[6,j]=0) and
(a[7,j]=0) and (a[8,j]=0) and
(a[9,j]=0) and (a[10,j]=0) and
(a[11,j]=0) and (a[12,j]=0) and
(a[13,j]=0) and (a[14,j]=0) and
(a[15,j]=0) and (a[16,j]=0) and
(a[17,j]=0) and (a[18,j]=0) and
(a[19,j]=0) and (a[20,j]=0) and
(a[21,j]=0) and (a[22,j]=0) and
(a[23,j]=0) then
for i:=1 to 28 do
if (a[i,j]<>1) and (a[i,j]<>2)
then a[i,j]:=a[i,j-1];
