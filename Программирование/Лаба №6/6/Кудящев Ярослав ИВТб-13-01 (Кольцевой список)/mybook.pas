...
case c of
    ...
    #9: tab;
    #8: if (y<>5) or (y<>1) then begin  x:=wherex+1;y:=wherey;
    ...
    #13: menu;
        ...
        c:=readkey;
        case c of
        #72: begin if (com>0) and (y>6) then begin up:=true; point;end;gotoxy(wherex,wherey-1);end;
