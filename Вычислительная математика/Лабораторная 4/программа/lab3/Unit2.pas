...
begin
  // Заполнение разностей в таблице
  P:=1;
  for i:=1 to n do
    for j:=1 to n do
      if i<>j then
  ...
  for i:=1 to n do
    ...
    Form2.strngrd2.Cells[0,7]:='Сумма = ';
    form2.strngrd2.Cells[8,7]:=formatfloat('0.00',L);
    form2.lbl7.caption:='Произведение диагональных элементов =  '+formatfloat('0.00000000000000',P);
    Form2.lbl1.Caption:='Ответ:  Y  =  '+FormatFloat('0.000000',L*P)
end;
...
begin
  ...
  draw_table;
  Form2.lbl3.Caption:='Искомое:  X  =  '+floattostr(masx[8]);
end;
